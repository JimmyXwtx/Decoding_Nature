...
In this project, due to the limitation of Javascript, the length of float after " , " = 16, which is far less than I need. I need to figure a way out to calculate the infinite length of the circulating decimals. Co-working with the Data Science Major student to figure out a common way to find the recurring period. In that case, I could make this project much more common and more possible. 

### Possible Library to research in the future:
[BigNumber.js](https://mikemcl.github.io/bignumber.js/)

[Decimals.js](https://mikemcl.github.io/decimal.js/)

### Acknowledgement
Thanks for prof. Joerg Blumtritt's teaching and allowing me to explore anything I am intersted in.

[Prof. Joerg Blumtritt](https://nyuad.nyu.edu/en/academics/divisions/arts-and-humanities/faculty/joerg-blumtritt.html)
